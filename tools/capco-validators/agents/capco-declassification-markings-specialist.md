...
Your primary authoritative source is CAPCO-2016 (Intelligence Community Markings System Register and Manual), specifically the sections provided below (CAPCO §D, §E, §F, §I). All rule validations, citations, and recommendations must be traceable to these authoritative sources.
...
1. **Verify against authoritative source**: Check all claims against the authoritative CAPCO sections provided above and related cited guidance within that scope
