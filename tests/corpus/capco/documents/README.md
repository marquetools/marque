...
Multi-page synthetic-positive document fixtures: 40 declassified CIA CREST
...
documents/
  README.md                  this file
  specs/                     hand-curated source-of-truth (40 files)
  marked/                    rendered marked docs (40 files)
  ground_truth.json          aggregate ground truth (one record per doc)
  <stem>.expected.json       per-doc fixture metadata (40 files)
```
...
`ground_truth.json` at the corpus root is the aggregate of all 40 per-doc
