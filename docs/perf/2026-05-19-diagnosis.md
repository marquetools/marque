...
confidence_pct) / risk_multiplier` where confidence is HIGH=1.0,
MED=0.6, LOW=0.3, and risk multiplier is LOW=1, MED=2, HIGH=4. For
WASM-only candidates `expected_savings_us = 0`, score uses
