...
| 3b | **Keystone-2**: #263 rule collapse — Stage-1 target 13–18 (amended 2026-05-07) using the pivot from 3a. Touches only `marque-capco/rules.rs` + rule-set construction. No schema bump. Independently revertable. Six sub-moves T026a–T026f per `tasks.md`; see top-of-file amendment banner. | #263 | IV, VI |
