...
By using Marque, you agree to this license. Knitli grants you these rights in exchange for your agreement. You must follow all of these terms to use Marque under this license. Any use of Marque outside the scope of this license agreement is a breach of this agreement and infringes on Knitli's intellectual property rights. If you want to use Marque differently from what this license allows, you must purchase a commercial license from Knitli Inc.
...
If Knitli patents cover any part of Marque, Knitli grants you a free, worldwide, perpetual, and irrevocable patent license to make, use, and import Marque (if allowed by export control laws) — but only for uses that this license permits. Your patent license and all other rights under the Marque License will end immediately and without notice if you:

- bring a patent lawsuit against Knitli or any Marque user claiming Marque (or a user's use of Marque) infringes on a patent, or
- challenge the validity or ownership of Knitli's copyrights, patents, or trademarks in Marque, or help someone else to challenge them.
...
- Keep Knitli's and Marque's names, logos, and trademarks intact as they appear in Marque's source code, documentation, and license notices when you copy or modify Marque (you *must* keep the license notices).
...
If you use Marque in a way that this license agreement doesn't allow, or if you don't follow any part of this agreement, your license ends automatically and immediately.
...
**If it's not your first violation, your license remains terminated until Knitli explicitly reinstates it in writing.**

Knitli may reinstate your terminated license, require different terms provisionally or permanently, or decline to provide you another license. All reinstatement decisions are at Knitli's sole discretion, on no required timeline, and with no obligation to act.

### Forgiving a Violation

If you made a good-faith effort to comply with the Marque License, you may appeal to Knitli to officially clear a violation so it does not count against you as either a first or second violation (i.e., expunge the record). Knitli may grant or deny such requests on a case-by-case basis, without setting any precedent.

---

## No Warranty and Limited Liability

**Marque comes with no warranties.** Knitli provides Marque "as is" and "as available." To the extent allowed by law, we disclaim all warranties — stated, implied, or required by statute. This includes the implied warranties of **merchantability** (any implied promise that Marque is fit to sell), **fitness for a particular purpose** (any implied promise that it suits your specific use), **title** (any implied promise that we own what we say we own), and **non-infringement** (any implied promise that your use doesn't infringe on someone else's rights). We don't guarantee that Marque will work as expected, meet your needs, run uninterrupted, or be free of errors or security issues.

**Our liability is limited.** You assume all risks, costs, and liability for your use of Marque. To the extent allowed by law, Knitli isn't liable for any **indirect, incidental, special, consequential, or punitive damages** — like lost profits, lost data, business interruption, or the cost of substitute software — even if we knew those damages were possible. If a court finds Knitli liable despite this disclaimer, **our total liability for all claims is capped at $50**.
...
- **Entire agreement.** This license — including the definitions, requirements, FAQ, and every other section of this document — is the entire agreement between you and Knitli regarding your use of Marque under these terms. It replaces any prior agreements or understandings about Marque's licensing (not including purchased commercial licenses, which carry separate terms).
- **Severability.** If any part of this license is found to be unenforceable, the rest remains in effect.
- **No waiver.** If Knitli doesn't enforce a term of this license, that doesn't mean we waive the right to enforce it later.
