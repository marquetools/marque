...
<!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00484">
	<sch:p xmlns:ism="urn:us:gov:ic:ism" ism:classification="U" ism:ownerProducer="USA" class="ruleText">
	  ...
	  <sch:rule id="ISM-ID-00484-R1" context="*[@ism:cuiBasic]">
		    <sch:assert test="util:meetsType(@ism:cuiBasic, $NmTokensPattern)" flag="error" role="error">
		    	[ISM-ID-00484][Error]  All @ism:cuiBasic attributes must be of type NmTokens.
		</sch:assert>
	  </sch:rule>
</sch:pattern>