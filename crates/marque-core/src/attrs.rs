...
//!
//! # Code generation
//! CVE enum variants (SciControl, DissemControl, etc.) are generated by
//! `marque-capco/build.rs` from ODNI CVE XML files. They are re-exported from
//! `marque-capco` and referenced here as the base types.
