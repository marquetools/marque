...
38 rules currently implemented at HEAD (post-PR-4b umbrella, post-W002 retirement): errors `E002`/`E005`–`E008`/`E010`/`E012`/`E014`–`E016`/`E021`/`E024`/`E031`/`E036`–`E039`/`E041`/`E053`–`E057`/`E061`–`E067`, style `S003`–`S005`/`S007` (`S004` is the first suggest-don't-fix-channel rule per issue #235 / #186 PR-3; `S005` covers REL TO membership-uncertain reduction per issue #206 — PR #488 retired its historical S006 companion and migrated S005 to `Phase::PageFinalization`; the Suggest/Info split was an engine-workaround, NOT §-grounded per CAPCO-2016 §H.8 + §D.2 Table 3 rule 21; `S007` covers bare NATO classification per PR 9c.2 / FR-048), warnings `W003`/`W004`/`W034` (`W001` retired in T035c-14 per CAPCO §F; `W002` retired in PR #507 closing #470 per §H.7 p123 — the shape `W002` was warning on is now authorized by the manual; `W004` added in PR 4b-B for joint-disunity-collapse per §H.3 p57 + §H.7 p123 — CV-4 PR 4b-B 8th-pass updated from §H.3 p56; the migration trigger lives on p57's "Derivative Use" bullets, not p56's grammar block), corrections `C001`. The exact-set is gated by `crates/capco/tests/post_3b_registration_pin.rs`.
