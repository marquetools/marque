// PR 3c.B Commit 10: legacy FixProposal-shape benchmark disabled pending rewrite.
// Stub `main` keeps the bench target compilable until the rewrite lands.
fn main() {}

#[cfg(any())] // PR 3c.B Commit 10: legacy FixProposal-shape test disabled pending rewrite
mod disabled_bench {
