    ...
    (
        ...
        &[
            ...
            ExpectedRuleCount {
                ...
                count: 2,
                issue: 0,
                reason: "correct firing: synthetic CIA CREST fixture has banner/portion classification mismatch (§H.7 pp123-125 reciprocal raise — PR 5 #276 closure)",
            },
            ExpectedRuleCount {
                rule: "E068",
                count: 2,
    ...
    (
        ...
        &[
            ...
            ExpectedRuleCount {
                ...
                count: 1,
                issue: 0,
                reason: "correct firing: synthetic CIA CREST fixture has banner/portion FGI marker mismatch (§H.7 p124 banner roll-up rule — PR 5 #276 closure)",
            },
        ],
    ),
    (
