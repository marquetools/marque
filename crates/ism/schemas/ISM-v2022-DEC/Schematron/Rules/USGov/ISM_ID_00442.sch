...
<!-- Notices - Distribution Notice: 
       ...
       -->
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00442" is-a="NoticeHasCorrespondingData">
    <sch:p xmlns:ism="urn:us:gov:ic:ism" ism:classification="U" ism:ownerProducer="USA" class="ruleText">
        [ISM-ID-00442][Error] If ISM_USGOV_RESOURCE and:
        ...
        Human Readable: USA documents containing a non-external IMCON_RSEN notice must also have RS data. 
    </sch:p>
	  <sch:p xmlns:ism="urn:us:gov:ic:ism" ism:classification="U" ism:ownerProducer="USA" class="codeDesc">
		...
		with a value containing the token [IMCON_RSEN] and does not specifiy attribute @ism:externalNotice with a 
	  ...
	  <sch:param name="ruleId" value="'ISM-ID-00442'"/>
