...
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00067" is-a="AttributeContributesToRollup">
  <sch:p xmlns:ism="urn:us:gov:ic:ism" ism:classification="U" ism:ownerProducer="USA" class="ruleText">
    ...
    in the document has the attribute @ism:disseminationControls containing [OC] 
    then the ISM_RESOURCE_ELEMENT must have @ism:disseminationControls containing [OC]. 
