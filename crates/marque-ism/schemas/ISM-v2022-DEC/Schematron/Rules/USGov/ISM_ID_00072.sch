...
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00072" is-a="AttributeContributesToRollup">
  <sch:p xmlns:ism="urn:us:gov:ic:ism" ism:classification="U" ism:ownerProducer="USA" class="ruleText">
    ...
    in the document have the attribute @ism:atomicEnergyMarkings containing [RD] 
    then the ISM_RESOURCE_ELEMENT must have @ism:atomicEnergyMarkings containing [RD].
