...
<sch:pattern xmlns:sch="http://purl.oclc.org/dsdl/schematron" id="ISM-ID-00081" is-a="AttributeContributesToRollup">
  <sch:p xmlns:ism="urn:us:gov:ic:ism" ism:classification="U" ism:ownerProducer="USA" class="ruleText">
    ...
    document have the attribute @ism:disseminationControls containing [FISA] 
    then the ISM_RESOURCE_ELEMENT must have @ism:disseminationControls containing [FISA].
