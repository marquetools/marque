...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [ISM-ID-00448][Error] Regardless of the version indicated on the instance document, the validation infrastructure 
        MUST use a version of 'AUTHCAT' that is version '201804' (Version:2018-APR) or later. 
    ...
    <sch:param name="RuleID" value="'ISM-ID-00448'"/>
</sch:pattern>