...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron" 
    id="ISM-ID-00520" is-a="ValidateValidationEnvCVE">
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [ISM-ID-00520][Error] Regardless of the version indicated on the instance document, the validation infrastructure
        MUST use a version of 'ROLE' that is version '202111' (Version:2021-NOV) or later. 
    ...
    <sch:param name="RuleID" value="'ISM-ID-00520'"/>
</sch:pattern>
