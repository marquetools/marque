...
| [`marque-capco`](./crates/marque-capco/) | 33 hand-written CAPCO rules (E001–E025, E032–E035, W001–W003, C001) consuming `marque-ism` predicates. Full SCI compartment + sub-compartment support per CAPCO-2016 §A.6. |
...
**MVP complete**. Full lint → fix → audit pipeline for raw text with 33 CAPCO
rules, including structural SCI compartment + sub-compartment validation
per CAPCO-2016 §A.6. CLI and WASM produce byte-identical NDJSON diagnostics. Configurable
