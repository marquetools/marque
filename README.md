...
| [`marque-capco`](./crates/capco/) | 38 hand-written CAPCO rules (E001–E036, S001–S002, W002–W003, C001) consuming `marque-ism` predicates. Includes SAR (Special Access Required) validation per §H.5 and structural SCI compartment + sub-compartment support per §A.6. |
