...
| 8.E | E041 | Intent-only `FactRemove(EXDIS, Scope::Portion)` (migrated in PR 3c.B Sub-PR 8.E.2 — closes #106 via `synthesize_intent_only_fixes` re-rendering; the parser within-category-separator gap is sidestepped, not closed) |
