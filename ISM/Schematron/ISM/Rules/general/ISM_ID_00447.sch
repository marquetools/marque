...
<sch:pattern xmlns:ism="urn:us:gov:ic:ism" xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <sch:p class="ruleText" ism:ownerProducer="USA" ism:classification="U">
        [ISM-ID-00447][Error] Regardless of the version indicated on the instance document, the validation infrastructure 
        MUST use a version of 'LIC' that is version '201508' (Version:2015-AUG) or later. 
    ...
    <sch:param name="MinVersion" value="'201508'"/>
    <sch:param name="SpecToCheck" value="'LIC'"/>
    <sch:param name="pathToDocument" value="'../../CVE/LIC/CVEnumLicLicense.xml'"/>
    <sch:param name="RuleID" value="'ISM-ID-00447'"/>
</sch:pattern>